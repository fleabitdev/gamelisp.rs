let searchIndex = [
	...
	[".", true, "meth-name-abbrv"],
	["meth-name-abbrv", true, "meth-name-abbrv"],
	["[]", true, "access-abbrv"],
	...
	["bitsar", true, "bitsar"],
	["rand", true, "rand"],
	["coin-flip", true, "coin-flip"],
	["chance", true, "chance"],
	["rand-select", true, "rand-select"],
	...
	["call-meth", true, "call-meth"],
	["has-meth?", true, "has-meth-p"],
	["is?", true, "is-p"],
